...
#include "chili/Game.hpp"
#include "chili/ChiliException.hpp"

int WINAPI wWinMain( HINSTANCE hInst,HINSTANCE,LPWSTR pArgs,INT )
{
	try
	{
		// fixes weird mouse coordinates
		SetProcessDPIAware();
		chili::MainWindow wnd( hInst,pArgs );		
		try
		{
			chili::Game theGame(wnd);
			while( wnd.ProcessMessage() )
			{
				theGame.Go();
			}
		}
		catch( const chili::ChiliException& e )
		{
