...
namespace sand::SpecialBehaviour
{
	class Rd_Cond {
	public:
		...
		bool LotteryWon()
		{
			return e2d::RNG::RandomPercentile() <= win_chance;
		}
	...
	public:
		bool operator()(World& world , int& ind1, int& ind2, const Element& elem2)
		{
			...
			{
				if (e2d::RNG::RandomPercentile() <= Element::SandSinkChance)
				{
					return true;
				}
			}
	...
	public:
		bool operator()(World& world ,int& ind1, int& ind2, const Element& elem2)
		{
			if (elem2.GetType() == Type::Water)
			{
				if (e2d::RNG::RandomPercentile() <= Element::SnowSinkChance)
				{ 
					if (e2d::RNG::RandomPercentile() <= Element::SnowToWaterChance)
					{
