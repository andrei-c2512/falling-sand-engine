...
namespace sand {
	...
	public:
		Chunk(e2d::RectI size0, World& world0, size_t index)
			:Size(size0),
			world(world0),
			Rand(0, 1),
			RandSpread(0, 1),
		...
		static int  GetDelta(int index, Direction direction, e2d::Size<int> dim);               // gets the number of indexes to pass to go to a certain direction on the 2D grid
	...
	public:
		...
		e2d::RectI Size; // how many elements fit
		e2d::RectI PhysicalSize;
