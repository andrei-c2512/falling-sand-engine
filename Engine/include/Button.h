...
public:
	...
	Button(const RectI& rect, Color c);
	Button(const RectI& rect, const Sprite& sprite);
...
public:
	...
	ElementButton( const Vec2I& pos , Type type0)
...
public:
	...
	WeatherButton(const Vec2I& pos,WeatherType type0)
