...
public:
	...
	virtual void Use(const Vec2D& pos) {};
	virtual void Update(float time);
	virtual bool Collision(const Rect& rect) { return false; };
...
public:
	...
	void Use(const Vec2D& pos)                              override;
	bool Collision(const Rect& rect)				  override;
