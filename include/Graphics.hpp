...
public:
	...
	template <typename E>
	void DrawSprite(int x, int y, const Sprite& s, RectI SpritePortion, const RectI& clip , E effect)
	{
	...
	void DrawSprite( Vec2_<T> pos, const Sprite& s,  RectI SpritePortion, const RectI& clip, E effect)
	{
		assert(WithinScreen(SpritePortion));
	...
	void DrawRect(Rect_<T , D> rect, Color c , E effect ,const RectI& clip = GetScreenRect())
	{
	...
	void DrawElementRect(RectI rect, Color c, const RectI& clip = GetScreenRect())
	{
	...
	void DrawRect_Transparent(Rect_<T , D> rect, Color c, const Sprite& sprite, int transparency, const RectI& clip = GetScreenRect())
	{
	...
	template<typename T, typename D>
	void DrawRect_Transparent(Rect_<T , D> rect, Color c, int transparency ,const RectI& clip = GetScreenRect())
	{
